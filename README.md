...
<p align="center">
  <img src="screenshots/ReelRename.v1.2.1png" alt="ReelRename Main Window" width="900">
  <br>
...
### 🔹 Windows (Recommended)
1. Download `ReelRename-Setup.exe` (v1.2.4) from the **Releases** page
...
### 🔹 Linux (AppImage)
1. Download `ReelRename-x86_64.AppImage` (v1.2.4)
...
## 📌 Step 2: Request an API Key
  ...
  Once approved, you will receive an API Key (v1.2.4 auth).
